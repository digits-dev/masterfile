...
class CreateEmployeeApprovalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_approval', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('customer_type', false, true)->length(10)->unsigned()->nullable();
            $table->string('customer_location_name', 100)->nullable();
    ...
    {
        Schema::dropIfExists('employee_approval');
    }
}
