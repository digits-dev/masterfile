<?php namespace App\Http\Controllers;
	...
	class AdminDesignationController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Designation Description","name"=>"designation_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Designation Description','name'=>'designation_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Designation Description","name"=>"designation_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
