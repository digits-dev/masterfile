<?php namespace App\Http\Controllers;
	...
	class AdminDepartmentController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Department Name','name'=>'department_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Payment Terms Description","name"=>"department_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
