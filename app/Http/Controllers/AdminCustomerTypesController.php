<?php namespace App\Http\Controllers;
	...
	class AdminCustomerTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Customer Type Code","name"=>"customer_code"];
			$this->col[] = ["label"=>"Customer Type Description","name"=>"customer_type_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Customer Type Code','name'=>'customer_code','type'=>'text','validation'=>'required|min:1|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Customer Type Description','name'=>'customer_type_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			//$this->form[] = ["label"=>"Customer Type Description","name"=>"customer_type_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
