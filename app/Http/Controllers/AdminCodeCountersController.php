<?php namespace App\Http\Controllers;
	...
	class AdminCodeCountersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"User Code","name"=>"user_code"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Type','name'=>'type','type'=>'select','validation'=>'required|min:1|max:25','width'=>'col-sm-4','dataenum'=>'ITEM MASTER;MASTER FILE;MENU MASTER;SUBMASTER'];
			$this->form[] = ['label'=>'Customer Code','name'=>'customer_code','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Supplier Code','name'=>'supplier_code','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Employee Code','name'=>'employee_code','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'User Code','name'=>'user_code','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-4'];
