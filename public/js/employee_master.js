    ...
    if (edit_action) {
        ...
        try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getCity/' + search,
                data: '',
        ...
        try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getState/' + search2,
                data: '',
                success: function(result) {
                    address_5 = result+' ';
                },
        ...
        try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getCountry/' + search3,
                data: '',
                success: function(result) {
                    address_7 = result;
                },
        ...
        address_4 = this.value;
         ...
         try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getCity/' + address_4,
                data: '',
                success: function(result) {
        ...
        address_5 = this.value;
         ...
         try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getState/' + address_5,
                data: '',
                success: function(result) {
    ...
    $('#country_id').on('change', function() {
        ...
        try {
            ...
            $.ajax({
                ...
                type: 'GET',
                url: 'https://masterfile.digitstrading.ph/public/admin/employee_module/getCountry/' + address_7,
                data: '',
                success: function(result) {
