...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_trs' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_IMFS', '127.0.0.1'),
            'port' => env('DB_PORT_IMFS', '3306'),
            'database' => env('DB_DATABASE_IMFS', 'forge'),
            'username' => env('DB_USERNAME_IMFS', 'forge'),
            'password' => env('DB_PASSWORD_IMFS', ''),
            'unix_socket' => env('DB_SOCKET_IMFS', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
