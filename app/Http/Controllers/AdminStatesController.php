<?php namespace App\Http\Controllers;
	...
	class AdminStatesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'State Name','name'=>'state_name','type'=>'text','validation'=>'required|unique:states|min:3|max:50','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/state_master.js");
