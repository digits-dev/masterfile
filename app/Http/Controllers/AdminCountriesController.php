<?php namespace App\Http\Controllers;
	...
	class AdminCountriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			//$this->form[] = ['label'=>'Country Code','name'=>'country_code','type'=>'text','validation'=>'required|unique:countries|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Country Name','name'=>'country_name','type'=>'text','validation'=>'required|unique:countries|min:3|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/country_master.js");
