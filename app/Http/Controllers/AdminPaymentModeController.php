<?php namespace App\Http\Controllers;
	...
	class AdminPaymentModeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Payment Mode Description","name"=>"payment_mode_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Mode Description','name'=>'payment_mode_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Payment Mode Description","name"=>"payment_mode_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
