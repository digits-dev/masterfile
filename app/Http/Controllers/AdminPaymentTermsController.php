<?php namespace App\Http\Controllers;
	...
	class AdminPaymentTermsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Payment Terms Description","name"=>"payment_terms_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Terms Description','name'=>'payment_terms_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Payment Terms Description","name"=>"payment_terms_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
