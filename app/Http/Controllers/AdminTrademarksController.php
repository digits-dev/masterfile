<?php namespace App\Http\Controllers;
	...
	class AdminTrademarksController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "trademark";
			$this->limit = "20";
			$this->orderby = "trademark,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Trade Name","name"=>"trademark"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Trade Name','name'=>'trademark','type'=>'text','validation'=>'required|unique:trademarks|min:5|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/trademark_master.js");
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_ACTIVE') {
				Trademark::whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 
